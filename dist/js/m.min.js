			...
			parents: function (t) {
				for (var e = [], i = this; i.length > 0; )
					i = n.map(i, function (t) {
						return (t = t.parentNode) && !$(t) && e.indexOf(t) < 0
							? (e.push(t), t)
							: void 0;
					});
				return U(e, t);
			...
			(t.ajax = function (e) {
				...
				d(o),
					o.crossDomain ||
						...
						(a.href = a.href),
						(o.crossDomain =
							l.protocol + '//' + l.host != a.protocol + '//' + a.host)),
...
var store = function (a, b) {
	...
	function d(a) {
		for (
			var b = a + '=', c = document.cookie.split(';'), d = 0, e = c.length;
			e > d;
			d++
		) {
		...
		return (
			...
			(this.heroInit = function () {
				...
				for (var a = 0; a < J.length; a++) {
					...
					1 !== b &&
						...
						(11 === b || 2 === b || 4 === b) &&
							f.find('.hat').css({ width: d + 2 + 'px' }),
						1 === b &&
							f.find('.mouse').css({ width: Math.floor(J[a][3] * m) + 'px' }),
						4 === b &&
							f
								.find('.body')
								.css({
						...
						13 === b &&
							...
							f
								.find('.strip1, .strip2')
								.css({ width: Math.floor(J[a][10] * m) + 'px' }));
				}
			...
			(this.drawInit = function () {
				(this.drawTotal = store('drawTotal')),
					(this.drawTotal =
						null === this.drawTotal ? x : parseInt(this.drawTotal, 10)),
					this.updateDraw();
			}),
			...
			(this.bindEvents = function () {
				...
				$('.btn-play').on(I, function () {
					a.nextAfterAnimation(a.$gametitle, K.PRE_BEGIN),
						a.$gametitle.addClass('hinge');
				}),
					...
					$('.btn-hero').on(I, function (b) {
						a.$heropick.toggleClass('in'),
							...
							this.isNew ||
								(store('stick-hero-404', !0), a.$newHeroIcon.hide()),
							b.stopPropagation(),
			...
			(this.unlockHero = function (a) {
				store('hero' + a, !0),
					$('.wrapper[data-src="' + a + '"]').removeClass('locked');
			}),
			(this.reset = function () {
				(this.score = 0),
					(this.count = 0),
					...
					(this.$box1 = $('<div />')
						...
						.css({
							...
							transform:
								'translate3d(' + -(k + this.BOX1.width) / 2 + 'px, 0, 0)',
							'-webkit-transform':
								'translate3d(' + -(k + this.BOX1.width) / 2 + 'px, 0, 0)',
						})),
					this.$hero
			...
			(this.preBegin = function () {
				...
				setTimeout(function () {
					a.$box2.css({
						...
						'-webkit-transform':
							'translate3d(' + -(k - a.BOX2.left) + 'px, 0, 0)',
					});
				}, 100);
			}),
			(this.begin = function () {
			...
			(this.heroWalk = function () {
				if (
					...
					if (
						...
						(this._perfectMin =
							this._validStickMin + (this.BOX2.width - v) / 2),
					...
					this.$hero.css({
						transform:
							'translate3d(' +
							(this.BOX2.left + this.BOX2.width - d - t - q) +
							'px, 0, 0)',
						'-webkit-transform':
							'translate3d(' +
							(this.BOX2.left + this.BOX2.width - d - t - q) +
			...
			(this.shifting = function () {
				...
				this.$feet.removeClass('walk').css('opacity', 0.9),
					...
					this.$box2.css({
						transform:
							'translate3d(' + -(k - o + this.BOX2.width) + 'px, 0, 0)',
						'-webkit-transform':
							'translate3d(' + -(k - o + this.BOX2.width) + 'px, 0, 0)',
					}),
					this.$movedStick.css({
						transform:
							'translate3d(' + -(this.dx + k) + 'px, 0, 0) rotate(90deg)',
						'-webkit-transform':
							'translate3d(' + -(this.dx + k) + 'px, 0, 0) rotate(90deg)',
					}),
					...
					setTimeout(function () {
						a.$box3.css({
							...
							'-webkit-transform':
								'translate3d(' + -(k - a.BOX3.left) + 'px, 0, 0)',
						});
					}, 100),
					this.$activeStick.css({
						transform: 'translate3d(' + -this.dx + 'px, 0, 0) rotate(90deg)',
						'-webkit-transform':
							'translate3d(' + -this.dx + 'px, 0, 0) rotate(90deg)',
					});
			}),
			(this.dying = function () {
				...
				for (var b, c = 0; c < M.length; c++)
					if (M[c].from <= a && a < M[c].from + (360 * M[c].per) / 100)
						return 'number' == typeof M[c].prize
							? (this.updateTotal(M[c].prize),
							  (b = M[c].prize + ' Watermelon!'))
							: (this.unlockHero(N), (b = 'Super Hero！！'));
			}),
			(this.updateScore = function (a) {
				void 0 !== a && (this.score += a),
					this.best < this.score &&
						((this.best = this.score), store('best', this.best)),
